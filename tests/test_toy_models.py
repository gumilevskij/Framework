...
if __name__ == '__main__':
    ...
    """
    fname = '../supplements/models/TOY/JLMP98.yaml'   # Simple monetary policy example
    #fname = '../supplements/models/TOY/RBC.yaml'      # Simple RBC model with deterministic shocks
    #fname = '../supplements/models/TOY/RBC1.yaml'     # Simple RBC model with stochastic shocks
    #fname = '../supplements/models/Templates/five_regions.yaml'   # Template example
    #fname = '../supplements/models/Templates/countries.yaml'   # Another template example
